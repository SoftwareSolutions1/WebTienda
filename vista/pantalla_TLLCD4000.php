                ...
                <div class="section group">
                    <div class="cont-desc span_1_of_2">
                        <ul class="back-links">
                            ...
                            <li>Televisor Led-LCD serie 4000</li>
                            <div class="clear"> </div>
                        </ul>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 13/TLLCD4000-small-1.jpg" />
                                            <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 13/TLLCD4000-large-1.jpg" title="" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 13/TLLCD40001-small-2.jpg"  />
                                        <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 13/TLLCD40001-large-2.jpg" title="" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 13/TLLCD40002-small-3.jpg"  />
                                        <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 13/TLLCD40002-large-3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 13/TLLCD40004-small-4.jpg" />
                                        <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 13/TLLCD40004-large-4.jpg" />
                                    </li>
                                </ul>
                            </div>
                            <div class="desc span_3_of_2">
                                <h2>Televisor Led-LCD serie 4000</h2>
                                <p>Conectividad inalambrica y un rendimiento de PMR  de 120. Entretenimiento con NetFlix, sonido SRS TruSurrond, Pantalla Full HD 1080p .</p>					
                                <div class="price">
                                    <p>Precio: <span>$10,000</span></p>
                                </div>
                                <div class="available">
                                    <ul>
                                        <li><span>Modelo:</span> &nbsp; TLLCD4000</li>
                                        <li><span>Peso para el envío:</span>&nbsp; 13.6 kg</li>
