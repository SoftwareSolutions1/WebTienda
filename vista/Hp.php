                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/HP/PRODUCTO 26/HPS133-small-1.jpg" />
                                            <img class="etalage_source_image" src="images/HP/PRODUCTO 26/HPS133-Large-1.jpg" title="" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/HP/PRODUCTO 26/HPS133-small-2.jpg"  />
                                        <img class="etalage_source_image" src="images/HP/PRODUCTO 26/HPS133-Large-2.jpg" title="" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/HP/PRODUCTO 26/HPS133-small-3.jpg"  />
                                        <img class="etalage_source_image" src="images/HP/PRODUCTO 26/HPS133-Large-3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/HP/PRODUCTO 26/HPS133-Large-4.jpg" />
                                        <img class="etalage_source_image" src="images/HP/PRODUCTO 26/HPS133-small-4.jpg" />
                                    </li>
                                </ul>
                            </div>
                            <div class="desc span_3_of_2">
                                <h2>HP SPECTRE 13.3</h2>
                                <p>Este es el diseño y la tecnología llevado a un nivel completamente nuevo. Materiales artesanales y artesanía llamativa crean una experiencia diferente a cualquier otra cosa. Con una única impresionante 10.4mm delgado diseño combinado con un rendimiento impresionante con procesador Intel® Core ™ i5 o i7 Procesador 2 , este portátil de lujo es totalmente irresistible.</p>					
                                <div class="price">
                                    <p>Precio: <span>$19,999</span></p>
                                </div>
                                <div class="available">
                                    <ul>
                                        <li><span>Modelo:</span> &nbsp; HPS133</li>
                                        <li><span>Peso para el envío:</span>&nbsp; 2.111301 kg</li>
