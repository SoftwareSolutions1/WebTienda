                ...
                <div class="section group">
                    <div class="cont-desc span_1_of_2">
                        <ul class="back-links">
                            ...
                            <li>Philips Smart TV Serie 8000 3D</li>
                            <div class="clear"> </div>
                        </ul>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 6/PSTV8000-small-1.jpg" />
                                            <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 6/PSTV8000-large-1.jpg" title="" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 6/PSTV80001-small-2.jpg"  />
                                        <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 6/PSTV80001-large-2.jpg" title="" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 6/PSTV80002-small-3.jpg"  />
                                        <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 6/PSTV80002-large-3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/PHILIPS/PRODUCTO 6/PSTV80003-small-4.jpg" />
                                        <img class="etalage_source_image" src="images/PHILIPS/PRODUCTO 6/PSTV80003-large-4.jpg" />
                                    </li>
                                </ul>
                            </div>
                            <div class="desc span_3_of_2">
                                <h2>Philips Smart TV Serie 8000 3D</h2>
                                <p>Thin LED de 42" - Full HD 1920 x 1080 píxeles - Smart TV 3D. posee un sintonizador digital, puerto USB con reproducción multimedia, cuatro entradas HDMI con Easy Link, cuatro pares de anteojos 3D y un adaptador wireless. La combinación de TV y películas en formato Blu-ray 3D es conveniente.</p>					
                                <div class="price">
                                    <p>Precio: <span>$9,999</span></p>
                                </div>
                                <div class="available">
                                    <ul>
                                        <li><span>Modelo:</span> &nbsp; PSTV8000</li>
                                        <li><span>Peso para el envío:</span>&nbsp; 17,4 kg</li>
