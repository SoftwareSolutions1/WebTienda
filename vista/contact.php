            ...
            <div class="preview-page">
                ...
                <div class="contact-form">
                    ...
                    <form method="post" action="contact-post.html">
                        <div>
                            <input name="userName" type="text" class="textbox textbox1" value="Nombre..." onFocus="this.value = '';" onBlur="if (this.value == '') {
                                        this.value = 'Nombre...';
                                    }" >
                            <input name="userEmail" type="text" class="textbox" value="Correo..." onFocus="this.value = '';" onBlur="if (this.value == '') {
                                        this.value = 'Correo...';
                                    }">
                            <input name="usersubject" type="text" class="textbox" value="Asunto..." onFocus="this.value = '';" onBlur="if (this.value == '') {
                                        this.value = 'Asunto...';
                                    }">
                            <div class="clear"></div>
                        </div>
                        <div>
                            <span><textarea name="userMsg" value="Message:" onFocus="this.value = '';" onBlur="if (this.value == '') {
                                        this.value = 'Message';
                                    }">Mensaje </textarea></span>
                        </div>
                        <div>
