                ...
                <div class="section group">
                    <div class="cont-desc span_1_of_2">
                        <ul class="back-links">
                            ...
                            <li>Pantalla Led 43" Uhd Smart Tv 43Uf6900</li>
                            <div class="clear"> </div>
                        </ul>
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="images/LG/PRODUCTO 14/PL43UST-small-1.jpg" />
                                            <img class="etalage_source_image" src="images/LG/PRODUCTO 14/PL43UST-large-1.jpg" title="" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/LG/PRODUCTO 14/PL43UST1-small-2.jpg"  />
                                        <img class="etalage_source_image" src="images/LG/PRODUCTO 14/PL43UST1-large-2.jpg" title="" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/LG/PRODUCTO 14/PL43UST2-small-3.jpg"  />
                                        <img class="etalage_source_image" src="images/LG/PRODUCTO 14/PL43UST2-large-3.jpg" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/LG/PRODUCTO 14/PL43UST3-small-4.jpg" />
                                        <img class="etalage_source_image" src="images/LG/PRODUCTO 14/PL43UST3-large-4.jpg" />
                                    </li>
                                </ul>
                            </div>
                            <div class="desc span_3_of_2">
                                <h2>Pantalla Led 43" Uhd Smart Tv 43Uf6900</h2>
                                <p>Resolución ULTRA HD 4K. 4K Upscaler. ULTRA Slim. webOS 2.0. Smart Share. Magic Remote. LG 4K ULTRA HD TV equipado con un decodificador HEVC que ofrece movimientos libres de desenfoques a 60 cuadros por segundo. USB, HDMI.</p>					
                                <div class="price">
                                    <p>Precio: <span>$13,699</span></p>
                                </div>
                                <div class="available">
                                    <ul>
                                        <li><span>Modelo:</span> &nbsp; PL43UST</li>
                                        <li><span>Peso para el envío:</span>&nbsp; 13.47 Kg</li>
